    ...
    if ( dir == 'a'):
        ...
        if (num_sen == 1 ):
            ...
            if (ron_a[0] >= (ron_a[1] + 2)):
                ...
                print('Error, falla en resgisto, borrando registro anterior y registrando nuevo')
...
# Implementa seguro 3 que se encarga de cuidar que la base de datos no se vea afectada por el error de
# de falla en lectura - cuando un tren se mueve pero no lo registra -