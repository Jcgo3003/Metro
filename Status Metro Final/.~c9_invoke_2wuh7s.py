    ...
    if ( dir == 'a'):
        ...
        if (num_sen == 1 ):
            ...
            if (ron_a[0] >= (ron_a[1] + 6)):
                ...
                # Error!!!
                return('Error, no se puede guardar el registro Sen1_a  ya tiene demasiados registros')
    ...
    # Seccion para insertar los datos en la bd 'b' ...
        ...
        if (num_sen == 3 ):
            ...
            if ( ron_b[2] >= ( ron_a[1] + 6) ):
                ...
                # Error!
                return('Error, no se puede guardar el registro sen2_b ya tiene demasiados registros')
        ...
        # Otros sensores en 'b'
            ...
            num_sen -= 1
                ...
                # BUSCAR MANERA DE LLEVAR REGISTRO DE ESTOS ERRORES
            ron_b[num_sen] += 1
...
#     ################ Comienzo - Leyendo archivo de BD ###############
#     if (os.path.isfile(nombrebd)):
#         # Conectando la BD
#         conexion = sqlite3.connect(nombrebd)
