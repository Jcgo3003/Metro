...
# Implementar un seguro como el seguro 3 en toda la bd para que no Ocurran errores como este A [5, 5, 3]
# Implementar sistema para cuando no alla suficientes datos para hacer los promedios, no se active la funcion de evalaucion