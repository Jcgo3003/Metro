...
#
# Funcion regis pierde la recepcion de datos sen_n para evitar problemas leyendo dicho campo
#   Dentro de esa funcion se implemento una linea sencilla que se encargara de rellenar ese campo
# Se implementaron los Sockets
#   Cada direccion tiene su socket por lo que se puede saber independientemente el estado
#   De las dos direcciones

# Para revisar manana
# El sensor 3 dir a envia demaciadas falsas senales
# Revisar tambien sensor 2
