...
# Pagina inicial index lista para recibir datos
# Funcion eva debe ser modificada, porque al principio muestra sin servicio
#       Tambien exclui al 6 junto con el 0 para que la evaluacion sea mas rapida
#       Modifique el icono, ahora cuando no tenga datos o sea 6 solo mostrara
#       Sin datos
